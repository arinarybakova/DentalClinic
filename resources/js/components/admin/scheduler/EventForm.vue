        ...
        <b-modal :id="id" :title="title" centered hide-footer>
            ...
            <b-form @submit="onSubmit">
                ...
                <b-form-group id="doctor-group" label="Pasirinkite gyd. odontologą" label-for="doctor-input">
                    ...
                    <b-form-select id="doctor-input" v-model="form.fk_dentist" :options="doctorOptions" class="form-control" />
                ...
                <b-form-group id="date-group" label="Data:" label-for="date-input">
                    ...
                    <b-form-input id="date-input" v-model="form.date" type="text" placeholder="Data" :disabled="disabled"></b-form-input>
                ...
                <b-form-group id="time-from-group" label="Laikas nuo:" label-for="time-from-input">
                    ...
                    <b-form-input id="time-from-input" v-model="form.timeFrom" type="text" placeholder="Laikas nuo" :disabled="disabled"></b-form-input>
                ...
                <b-form-group id="time-to-group" label="Laikas iki:" label-for="time-to-input">
                    ...
                    <b-form-input id="time-to-input" v-model="form.timeTo" type="text" placeholder="Laikas iki" :disabled="disabled"></b-form-input>
    
                </b-form-group>
    
                <form-error :validation="v$.form.timeFrom"></form-error>
    
                <b-button type="submit" variant="secondary" class="mt-3">{{ submitTitle }}</b-button>
            ...
            this.axios
                ...
                .then((response) => {
                    ...
                    for (var i = 0; i < response.data.users.length; i++) {
                        ...
                        this.doctorNames[response.data.users[i].id] = response.data.users[i].name;
                    }
                });
        },
    },
